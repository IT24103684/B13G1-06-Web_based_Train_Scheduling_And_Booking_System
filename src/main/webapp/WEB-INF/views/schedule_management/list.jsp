    ...
    <div class="bg-white rounded-lg shadow-sm border">
        <div class="p-6 border-b">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-semibold text-foreground">Schedule Management</h1>
                    <p class="text-sm text-muted-foreground mt-1">Manage train schedules</p>
                </div>
        ...
        <div class="p-6">
            ...
            <div id="loadingState" class="hidden">
                <div class="flex items-center justify-center py-12">
                    <div class="flex items-center space-x-2">
                        ...
                        <span class="text-muted-foreground">Loading schedules...</span>
                    </div>
                </div>
            </div>
            ...
            <div id="errorState" class="hidden">
                <div class="flex items-center justify-center py-12">
                    <div class="text-center">
                        ...
                        <p class="text-foreground font-medium">Failed to load schedules</p>
            ...
            <div id="emptyState" class="hidden">
                <div class="flex items-center justify-center py-12">
                    <div class="text-center">
                        <i class="fas fa-train text-muted-foreground text-3xl mb-4"></i>
                        <p class="text-foreground font-medium">No schedules found</p>
                        <p class="text-sm text-muted-foreground mb-4">Get started by adding your first schedule</p>
                        <button
                                onclick="window.location.href='/create-schedule'"
                                class="inline-flex items-center justify-center rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-primary text-primary-foreground hover:bg-primary/90 h-9 px-4 py-2"
                        >
...
<script src="/js/schedule_management/list.js"></script>
</body>
</html>